...
This Pro bot was made by [▼͜͜͜͜͜◣͡͡͡͡͡͡⃟⃟⃟⃟⃟࿅̤❰❰⃘꯭꯭Ꭰᴀʀᴋ💢̶̶꯭꯭꯭꛱͟͟͞❰❰꯭꯭꯭ ⃘Ꭰ꯭ᴇᴠᴉɭ✇࿅͡͡͡͡⃟⃟⃟̤◢͜](https://t.me/FULL_CRUAL_MIND)
Click /help or use button below to find out more about how to use me to my full potential."""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD ༒ 𝙏𝙄𝘼𝙉𝘼 ༒ TO YOUR GROUP ➕️", url="t.me/Stenzle_MariaGbot?startgroup=true"),
    ],
    [
   ...
   [
        InlineKeyboardButton(
            text="🎵 MUSIC GROUP 🎧", url="http://t.me/kk_music_army")
   ],
   [
        InlineKeyboardButton(
            text="✨MY BF✨", url="http://t.me/prince_3011"),
        InlineKeyboardButton(
            text="⚜️CHANNEL⚜️", url="https://t.me/"),
    ],
    [  
...
HELP_STRINGS = """ @Stenzle_MariaGbot
welcomeITH NEW FEATURES
...
DONATE_STRING ="""CONTACT ME ON @KRISNA_THULASI"""
