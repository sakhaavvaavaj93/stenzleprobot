...
import stenzleprobot.modules.sql.notes_sql as sql
from stenzleprobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from stenzleprobot.__main__ import DATA_IMPORT
from stenzleprobot.modules.helper_funcs.chat_status import user_admin
from stenzleprobot.modules.helper_funcs.alternate import typing_action

# from stenzleprobot.modules.rules import get_rules
import stenzleprobot.modules.sql.rules_sql as rulessql

# from stenzleprobot.modules.sql import warns_sql as warnssql
import stenzleprobot.modules.sql.blacklist_sql as blacklistsql
from stenzleprobot.modules.sql import disable_sql as disabledsql

# from stenzleprobot.modules.sql import cust_filters_sql as filtersql
# import stenzleprobot.modules.sql.welcome_sql as welcsql
import stenzleprobot.modules.sql.locks_sql as locksql
from stenzleprobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("stenzleprobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("stenzleprobot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `stenzleprobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("stenzleprobot{}.backup".format(chat_id))  # Cleaning file
