...
from stenzleprobot import MONGO_DB_URI
from stenzleprobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import stenzleprobot.events

        path = Path(f"stenzleprobot/modules/{shortname}.py")
        name = "stenzleprobot.modules.{}".format(shortname)
        ...
        mod.stenzleprobot = stenzleprobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["stenzleprobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "stenzleprobot/modules/*.py"
